-- Media Service 数据库初始化脚本
-- 创建核心表：files, uploads, multipart_parts, audit_logs, processing_jobs, quotas
...
-- 8. file_derivatives 表 - 文件衍生物表（缩略图、转码结果等）
