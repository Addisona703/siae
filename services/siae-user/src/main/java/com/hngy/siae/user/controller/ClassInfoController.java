...
public class ClassInfoController {
    ...
    @PreAuthorize("hasAuthority('" + USER_CLASS_CREATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + USER_CLASS_UPDATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + USER_CLASS_VIEW + "')")
    ...
    @PreAuthorize("hasAuthority('" + USER_CLASS_LIST + "')")
    ...
    @PreAuthorize("hasAuthority('" + USER_CLASS_DELETE + "')")
