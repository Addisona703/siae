...
public class ClassInfoController {
    ...
    public Result<ClassInfoVO> getClassById(
            @Parameter(description = "班级ID", example = "1", required = true, in = ParameterIn.PATH) @PathVariable("id") Long id) {
    ...
    public Result<List<ClassInfoVO>> listClassesByCollegeId(
            @Parameter(description = "学院ID", example = "1", required = true, in = ParameterIn.PATH) @PathVariable("collegeId") Long collegeId) {
    ...
    public Result<List<ClassInfoVO>> listClassesByMajorId(
            @Parameter(description = "专业ID", example = "1", required = true, in = ParameterIn.PATH) @PathVariable("majorId") Long majorId) {
    ...
    public Result<List<ClassInfoVO>> listClassesByYear(
            @Parameter(description = "入学年份", example = "2023", required = true, in = ParameterIn.PATH) @PathVariable("year") Integer year) {
