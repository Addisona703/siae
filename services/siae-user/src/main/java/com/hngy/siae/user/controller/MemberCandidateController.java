...
public class MemberCandidateController {
    ...
    @ApiResponse(responseCode = "200", description = "操作成功", content = @Content(schema = @Schema(implementation = MemberCandidateVO.class)))
    public Result<MemberCandidateVO> getCandidateById(@Parameter(description = "候选成员ID", required = true, example = "1", in = ParameterIn.PATH) @PathVariable("id") Long id) {
    ...
    @ApiResponse(responseCode = "200", description = "操作成功", content = @Content(schema = @Schema(implementation = MemberCandidateVO.class)))
    public Result<MemberCandidateVO> getCandidateByUserId(@Parameter(description = "用户ID", required = true, example = "101", in = ParameterIn.PATH) @PathVariable("userId") Long userId) {
    ...
    @ApiResponse(responseCode = "200", description = "操作成功", content = @Content(schema = @Schema(implementation = MemberCandidateVO.class)))
    public Result<MemberCandidateVO> getCandidateByStudentId(@Parameter(description = "学号", required = true, example = "20230001", in = ParameterIn.PATH) @PathVariable("studentId") String studentId) {
    ...
    public Result<List<MemberCandidateVO>> listCandidatesByDepartment(@Parameter(description = "部门ID", required = true, example = "1", in = ParameterIn.PATH) @PathVariable("departmentId") Long departmentId) {
    ...
    public Result<Boolean> deleteCandidate(@Parameter(description = "候选成员ID", required = true, example = "1", in = ParameterIn.PATH) @PathVariable("id") Long id) {
