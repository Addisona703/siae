...
public class AwardLevelController {
    ...
    public Result<AwardLevelVO> getAwardLevelById(
        @Parameter(description = "奖项等级ID", required = true, example = "1", in = ParameterIn.PATH) @PathVariable("id") Long id) {
    ...
    public Result<AwardLevelVO> getAwardLevelByName(
        @Parameter(description = "奖项等级名称", required = true, example = "国家级", in = ParameterIn.PATH) @PathVariable("name") String name) {
