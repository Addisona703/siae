...
public class AwardTypeController {
    ...
    public Result<AwardTypeVO> getAwardTypeById(@PathVariable Long id) {
    ...
    public Result<AwardTypeVO> getAwardTypeByName(@PathVariable String name) {
    ...
    public Result<Boolean> deleteAwardType(@PathVariable Long id) {
