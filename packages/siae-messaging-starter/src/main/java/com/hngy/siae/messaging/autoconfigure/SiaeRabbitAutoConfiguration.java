package com.hngy.siae.messaging.autoconfigure;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hngy.siae.messaging.annotation.DeclareQueueRegistrar;
...
public class SiaeRabbitAutoConfiguration {
    ...
    // HealthIndicator 已移至 SiaeRabbitHealthAutoConfiguration，避免 actuator 依赖问题
    ...
    /**
     * 注册 @DeclareQueue 注解处理器，自动扫描并声明队列、交换机和绑定。
     */
    @Bean
    @ConditionalOnMissingBean
    public DeclareQueueRegistrar declareQueueRegistrar() {
        return new DeclareQueueRegistrar();
    }
}
