...
public class UserProfileController {
    ...
    public Result<UserProfileVO> updateUserProfile(
        @Parameter(description = "用户ID", in = ParameterIn.PATH) @PathVariable Long userId,
    ...
    public Result<UserProfileVO> getUserProfileByEmail(
        @Parameter(description = "邮箱", in = ParameterIn.PATH) @PathVariable String email) {
    ...
    public Result<UserProfileVO> getUserProfileByPhone(
        @Parameter(description = "手机号", in = ParameterIn.PATH) @PathVariable String phone) {
